...
> SimpleImputer using mean/median/constant
8. What is the multivariate imputation method in sklearn?
> IterativeImputer or a thing like GroupImputer
...
> looking at data by using for example value_counts()
...
> Street Nr Suffix, as it is overwhelmingly missing
- Which, if either, are missing because they weren't recorded?
> Zipcode, because everything has a zipcode
...
```
> for every row in impute_map, take the indices of rows that allign, fill missing age values with the mean
